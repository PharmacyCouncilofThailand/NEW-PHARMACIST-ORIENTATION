...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "hero.loginHintPrefix": { TH: "🎉 สามารถดาวน์โหลด", EN: "🎉 Now available for download:" },
  "hero.loginHintLive": { TH: "รูปภาพบรรยากาศในงาน", EN: "Event Photos" },
  "hero.loginHintAnd": { TH: " และ ", EN: " & " },
  "hero.loginHintVideo": { TH: "คู่มือเภสัชกรใหม่ได้แล้ว!", EN: "the New Pharmacist Handbook!" },
...
"agenda.d1e5.desc": { TH: "การมอบใบอนุญาตประกอบวิชาชีพให้แก่เภสัชกรผู้สำเร็จการศึกษา", EN: "The granting of professional licenses to graduating pharmacists." },
  ...
  // Navbar extras
  "nav.materials": { TH: "คู่มือเภสัชกรใหม่", EN: "New Pharmacist Handbook" },
