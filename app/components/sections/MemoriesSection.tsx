...
const rawMemories: Memory[] = [
  { img: "/recent-photos/1E53B59F01CD44CD787B849199CF5C0F3E267069.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/51B995066240D701A0DD085CA2ED2FB1D7187928.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/773CB9D0F423CB04543E6FE0609A024C37881EBF.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/7F0FC46AD05B780BA0652C2E5C82B8D030F690E2.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/854EE14C1FE23AE07940D6DCC50B6F9711F6F69E.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/B5BD2714196F1975A1125DAF6C40D30278F262E5.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/E47A6A1D43F7DD875B3DF3D29F8BBCB7988618A9.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/F60B64B5CEA083BD81DE9B4D2E4466A69BE01059.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
  { img: "/recent-photos/FD1719C1BB54DC20CC78A18EBA501119E994A669.jpeg", year: "2026", title: "memories.photo.title", desc: "memories.photo.desc" },
            ...
            <div className="relative aspect-[3/4] overflow-hidden bg-slate-100">
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end opacity-0 group-hover/card:opacity-100 transition-all duration-400 translate-y-4 group-hover/card:translate-y-0">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-white font-bold text-lg leading-tight">{t(mem.title)}</h3>
                  <p className="text-slate-300 text-xs mt-1">{t(mem.desc)}</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="memories" ref={sectionRef} className="scroll-mt-40 relative py-16 md:py-24 lg:py-32 z-10 overflow-hidden transform-gpu">
      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 overflow-hidden">
          <MarqueeColumn items={rawMemories} direction="up" speed="55s" t={t} />
          <div className="hidden md:block pt-24">
            <MarqueeColumn items={reversedMemories} direction="down" speed="60s" t={t} />
          </div>
          <div className="hidden md:block">
            <MarqueeColumn items={rawMemories} direction="up" speed="50s" t={t} />
          </div>
        </div>
      </div>
    </section>
