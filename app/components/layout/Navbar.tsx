        ...
        >
          {isLoggedIn ? (
            <>
              ...
              <button
                onClick={() => { closeMenu(); }}
                className="w-full py-3.5 rounded-[1.125rem] text-center text-[13px] md:text-sm font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-[#163328] hover:bg-emerald-100 dark:hover:bg-[#1d4234] transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
